...
public class SendNotificationBeforeClassJobConfig {
    ...
    @Bean
    Job sendNotificationBeforeClassJob(final JobRepository jobRepository,
                                       final Step addNotificationStep,
                                       final Step sendNotificationStep) {
    ...
    @Bean
    Step addNotificationStep(final JobRepository jobRepository,
                             final PlatformTransactionManager platformTransactionManager,
                             final ItemReader<BookingEntity> addNotificationItemReader,
                             final ItemProcessor<BookingEntity, NotificationEntity> addNotificationItemProcessor,
                             final ItemWriter<NotificationEntity> addNotificationItemWriter) {
        return new StepBuilder("addNotificationStep", jobRepository)
                .<BookingEntity, NotificationEntity>chunk(CHUNK_SIZE, platformTransactionManager)
     ...
     */
    @Bean
    public Step sendNotificationStep(final JobRepository jobRepository,
                                     final PlatformTransactionManager platformTransactionManager,
                                     final ItemReader<NotificationEntity> sendNotificationItemReader,
                                     final ItemWriter<NotificationEntity> sendNotificationItemWriter) {
        return new StepBuilder("sendNotificationStep", jobRepository)
                .<NotificationEntity, NotificationEntity>chunk(CHUNK_SIZE, platformTransactionManager)
