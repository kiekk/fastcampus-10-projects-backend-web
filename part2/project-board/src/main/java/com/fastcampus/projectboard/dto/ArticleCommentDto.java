...
public record ArticleCommentDto(
    ...
    public static ArticleCommentDto of(Long articleId, UserAccountDto userAccountDto, String content, Long parentCommentId) {
        return ArticleCommentDto.of(null, articleId, userAccountDto, content, parentCommentId, null, null, null, null);
    }

    public static ArticleCommentDto of(Long id, Long articleId, UserAccountDto userAccountDto, String content, Long parentCommentId, LocalDateTime createdAt, String createdBy, LocalDateTime modifiedAt, String modifiedBy) {
